...
public sealed record MessageDto(Guid Id, Guid ChannelId, ReplyMessageDto? ReplyTo, string Content, DateTimeOffset Published, UserDto PublishedBy, DateTimeOffset? LastEdited, UserDto? LastEditedBy, DateTimeOffset? Deleted, UserDto? DeletedBy);
